...
function togglePeaMode() {
  ...
  if (peaMode == true) {
    ...
    document.getElementById("croatiaCover").src =
      "/assets/images/GalleryImages/Covers/Croatia Pea Cover.jpg"; // Modify the source of the image.
    document.getElementById("glastonburyCover").src =
      "/assets/images/GalleryImages/Covers/Glastonbury Pea Cover.jpg"; // Modify the source of the image.
    ...
    document.getElementById("paghamCover").src =
      "/assets/images/GalleryImages/Covers/Pagham Pea Cover.jpg"; // Modify the source of the image.
    ...
    document.getElementById("skiingCover").src =
      "/assets/images/GalleryImages/Covers/Skiing Pea Cover.jpg"; // Modify the source of the image.
    ...
    document.getElementById("edinburghCover").src =
      "/assets/images/GalleryImages/Covers/Edinburgh Pea Cover.jpg"; // Modify the source of the image.
    document.getElementById("portugalCover").src =
      "/assets/images/GalleryImages/Covers/Portugal Pea Cover.jpg"; // Modify the source of the image.
  } else {
    ...
    document.getElementById("croatiaCover").src =
      "/assets/images/GalleryImages/Covers/Croatia Cover.jpg"; // Modify the source of the image.
    document.getElementById("glastonburyCover").src =
    ...
    document.getElementById("lockdownCover").src =
      "/assets/images/GalleryImages/Covers/Lockdown Cover.jpg"; // Modify the source of the image.
    document.getElementById("paghamCover").src =
      "/assets/images/GalleryImages/Covers/Pagham Cover.jpg"; // Modify the source of the image.
    document.getElementById("generalCover").src =
      "/assets/images/GalleryImages/Covers/General Cover.jpg"; // Modify the source of the image.
    document.getElementById("skiingCover").src =
      "/assets/images/GalleryImages/Covers/Skiing Cover.jpg"; // Modify the source of the image.
    document.getElementById("footballCover").src =
      "/assets/images/GalleryImages/Covers/Football Cover.jpg"; // Modify the source of the image.
    document.getElementById("edinburghCover").src =
      "/assets/images/GalleryImages/Covers/Edinburgh Cover.jpg"; // Modify the source of the image.
    document.getElementById("portugalCover").src =
      "/assets/images/GalleryImages/Covers/Portugal Cover.jpg"; // Modify the source of the image.
  }
