...
function changeSiteTheme(siteThemeName) {
	...
	console.log(
		"%c" + "> Site theme changed: siteThemeName = " + siteThemeName + ", siteThemeHref = " + siteThemeHref,
		" background-color:" +
...
function getSideMenuSiteThemeSelection() {
	...
	// Add the border class to the selected theeme button in the side menu and remove the border from the others.
	if (siteThemeName == "1") {
		document.getElementsByTagName("side-menu-component")[0]
...
function clearTable(selector) {
	console.log(
		"%c" + ">> Re-usable Function: clearTable() called. Passed variables: selector = " + selector,
