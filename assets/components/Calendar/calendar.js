...
var clientId =
  "556098195944-b67uttdh8ogmoln1cglqrnt23rtr1rpi.apps.googleusercontent.com"; // Choose web app client Id, redirect URI and Javascript origin set to http://localhost.
var apiKey = process.env.APIKEY; // Choose public apiKey, any IP allowed (leave blank the allowed IP boxes in Google Dev Console).
